...
~~~
component、controller都是组件的，@Value都可以获取到yaml中的值
~~~

> 参考博客：https://blog.csdn.net/lafengwnagzi/article/details/74178374
...
`代码一、@Configuation 中注册（自定义拦截器）` ==重新整合==
